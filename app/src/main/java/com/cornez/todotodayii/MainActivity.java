...
public class MainActivity extends Activity {
    //https://learning.oreilly.com/library/view/android-programming-concepts/9781284070705/xhtml/15_Chapter09.xhtml
    ...
    //******************* TODO TASK ITEM VIEW ******************************
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
           //CheckBox isDoneChBx = (CheckBox) convertView.findViewById(R.id.chkStatus);
           final ViewHolder viewHolder = new ViewHolder();
           //Button btnDelete = (Button) convertView.findViewById(R.id.button);
            if (convertView == null) {
                ...
                viewHolder.btnDelete = (Button)convertView.findViewById(R.id.button);
                convertView.setTag(viewHolder.checkBox);

                viewHolder.checkBox.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        CheckBox cb = (CheckBox) viewHolder.checkBox;
                ...
                */
                ...
                viewHolder.btnDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ToDo_Item toDo_item = taskList.get(position);
                        taskList.remove(toDo_item);
                        mDBHelper.deleteTask(toDo_item.getId());
                        adapt.notifyDataSetChanged();
                ...
                viewHolder.checkBox = (CheckBox) convertView.getTag();
            }
            ToDo_Item current = taskList.get(position);


            viewHolder.checkBox.setText(current.getDescription());
            viewHolder.checkBox.setChecked(current.getIs_done() == 1 ? true : false);
            viewHolder.checkBox.setTag(current);
